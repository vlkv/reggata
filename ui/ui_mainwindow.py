...
#
# Created: Fri Jan 21 00:56:19 2011
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icons/icons/paperboat.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.dockWidget_items_table = QtGui.QDockWidget(MainWindow)
        self.dockWidget_items_table.setFloating(False)
        self.dockWidget_items_table.setFeatures(QtGui.QDockWidget.AllDockWidgetFeatures)
        self.dockWidget_items_table.setObjectName(_fromUtf8("dockWidget_items_table"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.dockWidget_items_table.setWindowTitle(QtGui.QApplication.translate("MainWindow", "Items table", None, QtGui.QApplication.UnicodeUTF8))
